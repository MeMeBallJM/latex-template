...
% Note environment
\definecolor{note_color_background}{HTML}{F9D8DE}
\definecolor{note_color_frame}{HTML}{F2ACB8}
\definecolor{note_color_title}{HTML}{FFFFFF}
\newtcbtheorem[number within=section]{note}{Note}
{
  ...
  boxed title style = {colback=note_color_frame, sharp corners},
  % Adjust colors
  colback= note_color_background,
  colframe= note_color_frame,
  coltitle = note_color_title,
}{definition}
